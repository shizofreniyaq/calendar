...
changeFormButton.onclick = function (e) {
   document.getElementById("events_block").classList.add("show");
}

var cancelAdd = document.getElementById("cancelAdd");
cancelAdd.onclick = function (e) {
   document.getElementById("events_block").classList.remove("show")
...
var closePopup = document.getElementById("overlay");
...
$('#hamburger').click(function() {
  ...
  $('.sidebar-wrapper').toggleClass( "slede_left" );
});